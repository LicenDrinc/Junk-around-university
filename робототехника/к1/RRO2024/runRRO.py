...
def BlackAndGreen(roomID, learn=True):
    ...
    while len(archivecolors)<11:
        h,s,v = rgb_to_hsv_tuple(center_sensor.rgb())
        if h > 100 and h < 150 and (s > 90 or v > 6):
            c = Color.GREEN
        elif (h > 110 and h < 250) or (s < 90 and v < 6):
            c = Color.BLACK
        else:
            c = None
...
# robot.settings(600,1000,225,1000)

# while ev3.buttons.pressed()==[]: pass
# wait(400)

# robot.straight(150)
# pid_to_X(speed=270,p=0.45,i=0.0045,d=10,stoplevel=40)
# robot.straight(25)
# pid_to_motor(speed=150,p=0.3,i=0.0005,d=6,distance=140)
# robot.turn(-90)
# pid_to_X(speed=200,p=0.3,i=0.0005,d=6,stoplevel=40)
# robot.straight(500)
# robot.turn(45)
# pid_right_to_leftX(speed=150,p=0.45,i=0.002,d=6,stoplevel=40,bw=60)
# robot.straight(25)
# pid_to_motor(speed=150,p=0.4,i=0.0005,d=6,distance=140)
# robot.turn(-80)
# robot.straight(-50)
# pid_to_X(speed=150,p=0.45,i=0.0045,d=10,stoplevel=40)
# rstop()
# robot.reset()
# robot.drive(450,85)
# while robot.distance()<50: pass
# pid_to_motor(speed=400,p=0.45,i=0.0045,d=10,distance=600)
# pid_to_motor(speed=320,p=0.45,i=0.0045,d=10,distance=600)
# pid_to_X(speed=300,p=0.45,i=0.0045,d=10,stoplevel=40)
# robot.turn(90)
# robot.straight(300)
...
# robot.straight(100)
# pid_to_motor(speed=500,p=0.59999,i=0.0019,d=9,distance=3900)
# pid_to_motor(speed=335,p=0.59999,i=0.0019,d=9,distance=1500)
# pid_to_X(speed=275,p=0.59999,i=0.0019,d=9,stoplevel=40)
# robot.straight(200)
...
for i in range(5,2,-1):
    if i==5:
        pid_to_motor(speed=280,p=0.3,i=0.001,d=5,distance=495)
    else:
        pid_to_motor(speed=180,p=0.3,i=0.001,d=5,distance=158)
